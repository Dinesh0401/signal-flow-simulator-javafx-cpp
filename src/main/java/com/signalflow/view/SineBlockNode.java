...
/**
 * Visual representation of a SineBlock — Simulink style.
 * Small rectangular block with "∿ Sine" label.
...
public class SineBlockNode extends BlockNode {
    ...
    private void openPropertiesDialog() {
        ...
        grid.add(makeValueLabel("SineBlock"), 1, row++);

        // Function
        grid.add(makePropertyLabel("Function:"), 0, row);
        grid.add(makeValueLabel("sin(t)"), 1, row++);
